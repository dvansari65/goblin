...
- **🎯 Actionable Output Generation**: Instead of forcing you to manually dig through pages, Goblin synthesizes selected documentation into clear integration instructions and production code snippets showing exactly how to use the library.
...
2. Click the **Goblin** extension icon in your toolbar.
